...
import com.global.MedicineNow.service.TokenServiceMedico;
...
@Component
public class AuthorizationMedicoFilter extends OncePerRequestFilter{

    @Autowired
    TokenServiceMedico tokenService;
